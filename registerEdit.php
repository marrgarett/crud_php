...
<body>
  <div class="container">
    ...
    $row = mysqli_fetch_assoc($result)
      ?>
    <form action="registerSave.php?id=<?php echo $row['id']; ?>" name="myForm" class="row g-3" method="post"
      ...
      <div class="col-md-6">
        ...
        <input type="password" value="<?php echo $row["pass_word"]; ?>" name="pass_word" class="form-control"
          id="inputPassword4">
      </div>
      <div class="col-12">
      ...
      <div class="col-12">
        ...
        <input type="text" value="<?php echo $row["address2"]; ?>" name="address2" class="form-control"
